...
def ControlVector_Webster(LenLink, TotalTimeStep, SignalControl, Time_SignalPeriod, LostTime):
    ...
    for sig in SignalControl:
        ...
        for j in range(sig.GreenSplit.shape[0]):
            ...
            FinalSignal = CycleList[StartTime:EndTime, :]

            ControlVector = np.vstack([ControlVector, FinalSignal])  # Integrate the offset thread
...
ControlVector_Webster(21, 300, SignalControl, [900, 1800, 900], 5)
